import requests, json, yaml, smtplib
from email.mime.text import MIMEText

HEADERS = {'Content-Type': 'application/json', 'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36'}
GMAIL_ADDRESS = "address@gmail.com"
...
with open("products.yaml") as stream:
    product_ids = yaml.safe_load(stream)
